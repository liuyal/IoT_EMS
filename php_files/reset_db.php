<?php
    ...
    try 
    {
        ...
        $result = mysqli_query($connect,"create table DATA( ID INT NOT NULL AUTO_INCREMENT, TIME BIGINT, TEMP DECIMAL (18, 2), HUM DECIMAL (18, 2), PRIMARY KEY (ID) );") or die(mysqli_error());
    }
